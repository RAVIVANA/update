...
public class LoanController {
	...
	public String New_loan_application(@Validated LoanApplicationInput l, Model model) {
		...
		applicationEventPublisher.publishEvent(new LoanAppRequestEvent("New Loan Application Filled", "No User"));
		return "loan_new_application_form";
	}
	...
	public String updateLoanApplication(@Validated LoanApplicationInput loanApplication) {
		...
		applicationEventPublisher.publishEvent(new LoanAppApprovalEvent("Loan Application Updated", "No User"));
		return "Application";
