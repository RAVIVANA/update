...
public class AccountController {
	...
	public String accountApplicationSave(@Validated AccountApplicationInput accountApplication, Model model) {
		...
		ac.save(account);
		applicationEventPublisher.publishEvent(new AccountAppRequestEvent("New Application Form Filled", "No User"));
		return "Account_new_application_form";
	}
	// ===========================================================================================
	...
	public String save_to_account_database(@Validated AccountInput account, Model model) {
		...
		ac.save1(a);
		applicationEventPublisher.publishEvent(new AccountAppApprovalEvent("Account Application Approved", "No User"));
		// change the return
		return "Account_new_application_form";
	}
