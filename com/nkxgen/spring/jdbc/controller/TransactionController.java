...
public class TransactionController {
	 ...
	 * // loan_repayment
	 * 
	 * @RequestMapping(value = "/getloanrepaytdetails", method = RequestMethod.POST) public String
	 * getloanrepaytdetails(@RequestParam("accountNumber") long loan_id, Model model) { long loan_Id = loan_id;
	 * LoanAccount account = ti.getLoanAccountById(loan_Id); model.addAttribute("account", account); return
	 * "sub_loan_repayment.html"; }
	 */
